...
class LocationsData {
    ...
    /** The locations below adapted from the video below to fit the data I wanted to store and display.
     * Sarno, N. (2021), Swiftful Thinking - Project Setup with Assets and Custom Data Model | SwiftUI Map App #1. Link available at :
     * https://www.youtube.com/watch?v=11iFAWFO0AU&ab_channel=SwiftfulThinking
     */
     ...
     * Give Food API, Available at: https://www.givefood.org.uk/api/2/docs/#foodbanks/search
     */
